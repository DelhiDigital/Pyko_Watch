...
function createEnvelopOrchestrator({ plugins, }) {
    ...
    for (const { onContextBuilding, onExecute, onParse, onSubscribe, onValidate, onEnveloped, instruments: pluginInstruments, } of plugins) {
        ...
        if (pluginInstruments) {
            instruments = instruments ? (0, instruments_1.chain)(instruments, pluginInstruments) : pluginInstruments;
        }
    }
